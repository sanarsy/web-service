...
function delkondisi($id_kondisi){ //fungsi delete
    $this->load->model('model_app'); //load model
    $this->model_app->delkondisi($id_kondisi); //ngacir ke fungsi delTransaksi
    redirect('kondisi/kondisi_list'); //redirect
 ...
 function save()
 {
 	...
 	$nama_kondisi = (trim($this->input->post('nama_kondisi')));
 	$waktu_respon = (trim($this->input->post('waktu_respon')));
	...
	$history['deskripsi'] = "insert new kondisi";
 ...
 function update()
 {
	...
	$history['deskripsi'] = "update new kondisi";
	$history['id_user'] = $id_user;
