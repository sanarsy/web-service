...
-->	
			...
			<ol class="breadcrumb">
				...
				<li class="active">Data List Terima Barang </li>
			</ol>		
		</section>
									...
									<tbody>
											...
											<tr style="font-size: 12px">
												...
												<td data-field="id">
													<?php if($row->status==1 ) 
														{?>												
														<a title="Terima Barang" class="ubah btn btn-primary btn-xs" href="<?php echo base_url();?>stbarang/approval_user/<?php echo $row->id_st;?>"><span class="fa fa-check-square-o" ></span> klik terima</a>	
