...
-->	
			...
			<ol class="breadcrumb">
				...
				<li class="active"> Tambah Akses User </li>
									...
									<!-- /.box-body -->
										<form method="post" action="<?php echo base_url();?><?php echo $url;?>"  enctype="multipart/form-data">
											<input type="hidden" class="form-control" name="id_user" value="<?php echo $id_user;?>">
												<div class="box box-danger">
													...
													<div class="box-header with-border">
														<h3 class="box-title"> Tambah Akses User </h3>
													</div>														
													<!-- /.form group -->
											...
											<!--		<div class="box-body">														
													...
													<div class="box-body">														
														<label> Image </label>
														<input type="file" class="form-control" name="photo" placeholder="<?php echo $photo;?>" value="<?php echo $photo;?>" accept="image/*" required>
													</div>
