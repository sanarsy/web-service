...
-->	
			...
			<ol class="breadcrumb">
				...
				<li class="active"> Data Urgency/SLA </li>
			</ol>		
		</section>
				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header with-border">
							<a href="<?=base_url('')?>kondisi/add" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true">
							</i> Tambah Data SLA</a>
						</div>
<!-- Box body -->						
						<div class="box-body">
								...
								<thead>
									...
									<tbody>
										...
										<tr>
											...
											<td >
													<a href="<?php echo base_url('kondisi/edit/');?><?php echo $row->id_kondisi; ?>" class="btn  btn-success btn-xs fa fa-edit"> edit</a>
													<a href="<?php echo base_url('kondisi/delkondisi/');?>/<?php echo $row->id_kondisi;?>
														"class="btn  btn-warning btn-xs fa fa-trash-o"
														onClick="return confirm('Yakin Ingin Menghapus ID (<?php echo $row->id_kondisi; ?>) ? ... ')"> Hapus
													</a>
											</td>
										</tr>
										<?php endforeach;?>
